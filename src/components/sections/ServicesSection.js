  ...
  return (
    <section id="services" className="relative overflow-hidden py-12 sm:py-16">
      ...
      <div className="relative mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="no-scrollbar flex [touch-action:pan-x_pan-y] snap-x snap-proximity gap-4 overflow-x-auto overflow-y-hidden overscroll-x-contain px-4 pb-2 sm:grid sm:snap-none sm:grid-cols-2 sm:gap-5 sm:overflow-visible sm:px-0 lg:grid-cols-3">
